	...
	<div class="container-fluid">
		<div class="row card">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<a class="navbar-brand " href="<%=request.getContextPath()%>/images/logo.png"> <img src="<%=request.getContextPath()%>/images/logo.png"
					class=img-fluid max-width: 10%" alt="LOGO">
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav mr-auto">
						<li class="nav-item active"><a class="nav-link "
							href="lister">Collaborateurs</a></li>
						<li class="nav-item"><a class="nav-link"
							href="statistiques.html">Statistiques</a></li>
						<li class="nav-item"><a class="nav-link"
							href="activites.html">Activités</a></li>
					</ul>
				</div>
			</nav>
		</div>
	...
	<div class="container-fluid">
		...
		<header>
			...
			<div class="row">
				<div class="col-8"></div>
				<div class="col-4">
					<a class="btn btn-dark" href="creer">Ajouter un nouveau
						collaborateur</a>
				</div>
			</div>
						...
						<div class="col-lg-4">
							<div class="card bg-light mb-3" style="max-width: 20rem;">
								<div class="card-header">
									<strong>Nom: </strong>
									<%=collab.getNom()%>
									<br><strong>Prenom :</strong> <%=collab.getPrenom()%></div>
								<div class="card-body">
									<div class="row">
										<div class="col-lg-12" >
										...
										<div class="col-lg-12">
											...
											<ul class="list-unstyled">
												<li><strong>Adresse : </strong> <%=collab.getAdresse()%></li>


												<li><strong>Date de Naissance :</strong> <%=collab.getDateDeNaissance()%></li>


												<li><strong>Numéro de Sécurité Social :</strong> <%=collab.getNumDeSecuSocial()%></li>


												<li><strong>Matricule :</strong> <%=collab.getMatricule()%></li>
												
												<li><strong>Date de création :</strong> <%=LocalDate.now()%></li>

												<li><strong>Email :</strong> <%=collab.getNom() + collab.getPrenom() + "@societe.com"%></li>
